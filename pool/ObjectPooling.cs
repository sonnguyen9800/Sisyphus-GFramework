...
/// Orignal: https://github.com/q8geek/Godot-4-Basic-Dynamic-Pool/blob/main/Pool.cs
/// Modified by: TCU
/// Modified date: 2022-11-06
namespace SisyphusFramework
{
    public abstract partial class ObjectPooling : Node
    {
        ...
        public ObjectPooling(PackedScene[] packs, Node poolParent)
        {
